...
-- Employee count by department number & export
SELECT count(ce.emp_no), de.dept_no
INTO current_empt_dept
...
-- Department Retirees - updated current_emp list with departments
...
-- Sales & Develpment Department Retirees
SELECT ce.emp_no, ce.first_name, ce.last_name, d.dept_name
FROM current_emp as ce
INNER JOIN dept_emp AS de
ON (ce.emp_no = de.emp_no)
